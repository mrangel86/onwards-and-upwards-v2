  ...
  return <div className="font-inter bg-background min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 pb-10">
        ...
        <section className="pt-10 pb-6">
          ...
          <img src={post.hero_image_url || "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=1200&q=80"} alt={post.title} className="w-full h-60 md:h-80 object-cover rounded-xl shadow mb-6" />
        </section>
        ...
        {/* Content body */}
        <section className="prose prose-lg max-w-none" dangerouslySetInnerHTML={{
        __html: post.content || ""
      }} />
